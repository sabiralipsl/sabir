...
rDownloadURL = "https://github.com/sabiralipsl/sabir/releases/download/sabir/sub_xui_sabirali.tar.gz"
...
def configure():
    ...
    os.system("wget -q https://github.com/sabiralipsl/sabir/releases/download/sabir/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    os.system("wget -q https://github.com/sabiralipsl/sabir/releases/download/sabir/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
